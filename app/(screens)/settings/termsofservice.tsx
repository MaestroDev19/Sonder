    ...
    <View>
      ...
      <View style={{ paddingBottom: 50 }}>
        ...
        >
          ...
          <Text className="text-light-grey mt-4">
            By accessing and using the Sonder application ("App"), you agree to
            comply with and be bound by these Terms of Use ("Terms"). If you do
            not agree to these Terms, please do not use the App.
          </Text>
          <H2>2. Description of Service</H2>
          <Text className="text-light-grey mt-4">
            Sonder allows users to connect based on their Spotify music tastes.
            By using the App, you can interact with other users, share music
          ...
          <Text className="text-light-grey mt-4">
            ...
            {"\n\n"}• Uploading or sharing content that is offensive,
            defamatory, or infringing on intellectual property rights
            {"\n\n"}• Engaging in activities that disrupt or harm the App or its
            users
            {"\n\n"}
            You retain ownership of any content you upload or share through the
            App. However, by doing so, you grant Sonder a non-exclusive,
          ...
          <Text className="text-light-grey mt-4">
            ...
            purpose, and non-infringement. We are not liable for any indirect,
