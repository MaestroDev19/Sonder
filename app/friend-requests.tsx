...
export default function FriendRequestsPage() {
    ...
    return (
        <Page>
            ...
            {   
                friendRequests.isLoading ? <Skeleton width="100%" /> :
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                            <Avatar width={50} height={50} src={item.sender_avatar} initials={item.sender_username.at(0)} />
                            <Text className="text-white text-xl font-semibold">{item.sender_username}</Text>
                            ...
                            <View className="flex flex-row items-center gap-3 ml-auto">
                                ...
                                >
                                    {
                                        acceptFriendRequestMutation.isPending ? <ActivityIndicator className="text-green-500"/> :
                                ...
                                >
                                    {
                                        rejectFriendRequestMutation.isPending ? <ActivityIndicator className="text-red-500"/> :
